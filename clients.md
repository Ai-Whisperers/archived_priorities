...
| Client | Repo | URL | Contact | Status |
|--------|------|-----|---------|--------|
| Superspuma | /root/superspuma | superspuma.paragu-ai.com | Leticia Roig (via Sarah WA) | Active — missing features |
...
| Fun4Me | /root/fun4me-store | fun4me.paragu-ai.com | Bram + Rach | Auth fixed, push pending |
...
## Parag u-ai Builder Sites (/root/sites/)
| Client | Directory | Built From |
|--------|-----------|------------|
| Bufete Mendez | bufete-mendez | paragu-ai-builder |
| De Abasto a Casa | de-abasto-a-casa | paragu-ai-builder |
| Granja Cabral | granja-cabral | paragu-ai-builder (dup) |
| Nexa Paraguay | nexa-paraguay | paragu-ai-builder (dup) |
| Nexa Propiedades | nexa-propiedades | paragu-ai-builder |
| Polki Squad | polki-squad | paragu-ai-builder |
| Stoicfinch | stoicfinch | paragu-ai-builder |
| Superspuma | superspuma | paragu-ai-builder (dup) |
